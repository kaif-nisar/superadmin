...
async function loadTests() {
    try {
        const response = await fetch(`${BASE_URL}/api/v1/package/test-database`);
    ...
    try {
        ...
        tests.forEach(test => {
            ...
            optionElement.addEventListener("click", function (e) {
                ...
                console.log("inputarray2", inputarray2);
                console.log("sample_types2:", sample_types2);
...
tagsdiv2.addEventListener("click", function (e) {
    if (e.target.classList.contains("delete-btn2")) {
        ...
        if (tag) {
            ...
            console.log("Updated inputarray2:", inputarray2);
            console.log("Updated sample_types2:", sample_types2);
        }
    }
});
...
function addPanneltodatabase() {
    ...
    document.getElementById('submitButton').addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await fetch(`${BASE_URL}/api/v1/user/add-package`, {
                method: 'POST',
