(async function () {
    ...
    value1 = report._id;
    const baseUrl = `http://localhost:8000/pages/download_reports.html`;
    localStorage.clear();
    ...
    async function qrcodegenerator() {
        ...
        try {
            const response = await fetch(`http://localhost:8000/api/v1/user/generate-qr`, {
                method: 'POST',
    ...
    document.getElementById('PDFsettinganchr').addEventListener('click', async (event) => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:8000/api/v1/user/adding-pdf-data`, {
                method: 'POST',
                headers: {
    ...
    async function sendReport() {
        ...
        sendReportButton.addEventListener('click', async (e) => {
            ...
            try {
                const response = await fetch(`http://localhost:8000/api/v1/user/get-pdf`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    async function sendSMS(phoneNumber, pdfUrl) {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:8000/api/v1/user/send-sms`, {
                method: 'POST',
                body: formData
            });
    ...
    async function sendEmail(email) {
        try {
            ...
            const response = await fetch(`http://localhost:8000/api/v1/user/send-email`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async function fetchreport() {
        try {
            const response = await fetch(`http://localhost:8000/api/v1/user/ReportData`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    async function populateHeader() {
        ...
        patientdetails.innerHTML = `<div class="format1left2">
                ...
                <div class="format1-infor-div" id="investDiv"><div class="format1-tags">Investigations:</div> <div class="value">${report.uniquetestArray}</div></div>
            </div>
            ...
            <div class="sign click qr-div">
                <img id="qrimg"
                    src="https://res.cloudinary.com/dmlfjbpb5/image/upload/v1730987604/vximbk8olbhmhmhp5ele.jpg">
            </div>
            `;
    ...
    async function barcodegenerator() {
        ...
        try {
            const response = await fetch(`http://localhost:8000/api/v1/user/generate-barcode`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    function renderData(data) {
        ...
        data.CategoryAndTest.forEach((categoryData, index) => {
            ...
            //         remarkCell.colSpan = 4; // Span all columns
    ...
    async function fetchTemplateImages() {
        try {
            const response = await fetch(`http://localhost:8000/api/v1/user/templates`, { method: "POST" }); // Update URL as per your backend
            const data = await response.json();
    ...
    async function signoffdivfunction() {
        ...
        document.getElementById("signOff").addEventListener("click", async function (e) {
            ...
            try {
                const response = await fetch(`http://localhost:8000/api/v1/user/editReportsignofffield`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    async function updatebookingisreportreadyfield(bookingid) {
        try {
            const response = await fetch(`http://localhost:8000/api/v1/user/CompleteBookingcontroller`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    async function fetchLabSignAndSetInputs() {
        try {
            ...
            const response = await fetch(`http://localhost:8000/api/v1/user/getLabInchargeSign`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
