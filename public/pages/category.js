...
//     fetch(`${BASE_URL}/api/v1/admin/category-list`)  // Fetch the categories list from the backend
...
//                         <td>
//                             <a href="#" onclick="loadPage('editCategory', '${category._id}')"><i class="fas fa-edit"></i> Edit   </a> 
//                             <a href="#" onclick="loadPage('testList', '${category._id}')"></i> View tests</a>
//                         </td>
//                     `;
//                     categoryListElement.appendChild(row);
//                 });
//             } else {
//                 categoryListElement.innerHTML = '<tr><td colspan="2">No categories found.</td></tr>';
//             }
//         })
//         .catch(error => {
...
async function saveOrderToServer(updatedOrder) {
    ...
    try {
        const response = await fetch(`${BASE_URL}/api/v1/admin/updatecategoryOrder`, {
            method: "POST",
            headers: {
